...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_dp25h8c", "template_6w794nq", form.current, {
      publicKey: "LoGmbTb-wdjz2Ev_C",
    });
    e.target.reset();
  };
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <h3 className="contact_card-title">Whatsup</h3>
              <span className="contact_card-data">999-888-777</span>
              <a
                href="https://api.whatsup.com/send?phone=+251947126176$text=HELLO, more Information!"
            ...
            <div className="contact_card">
              ...
              <a href="https://m.me/crpticalcoder" className="contact_button">
                Write Me
              </a>
              <i className="bx bx-right-arrow-alt"></i>
            </div>
